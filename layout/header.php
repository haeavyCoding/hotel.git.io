...
<div class="subHeader flex" id="navbar">
        ...
        <div class="contact-subheader flex">
            ...
            <a href="mailto: info@theramayana.in" class="mob flex"><i class="fa-regular fa-envelope"></i>
                ...
                <a class="sign_in_subheader" href="registration.php" onclick="popup()">SignIn</a>
        </div>
        <div class="contact-subheader responsive-subheader flex">
            ...
            <a href="mailto: info@theramayana.in" class="mob flex"><i
                    class="responsive-gmail fa-regular fa-envelope"></i>
            </a>
                ...
                <header class="mainHeader flex" id="main_header">
                    ...
                    <div class="nav-bar" id="slidermenu">
                        ...
                        <ul class="menu-bar flex">
                            ...
                            <li class="menu">
                                <a href="booking.php" class="book-online hoverable-menu flex">
                                    <i class="fa-solid fa-calendar-days"></i> BOOK ONLINE</a></li>
                        </ul>
                    </div>
